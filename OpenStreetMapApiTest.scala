...
object checks {
  ...
  object osm {
    ...
    object node {
      ...
      def version(id: Int, version: io.gatling.core.session.Session => io.gatling.commons.validation.Validation[String]): HttpCheck =
        xpath("""/osm/node[@id="""" + id + """"]/@version""").is(version)

      def uid(id: Int, uid: io.gatling.core.session.Session => io.gatling.commons.validation.Validation[String]): HttpCheck =
        xpath("""/osm/node[@id="""" + id + """"]/@uid""").is(uid)
      def user(id: Int, uid: String): HttpCheck =
        xpath("""/osm/node[@id="""" + id + """"]/@user""").is("user_"+uid)
      def changeset(id: Int, changesetid: io.gatling.core.session.Session => io.gatling.commons.validation.Validation[String]): HttpCheck =
    ...
    object way {
      ...
      def nd(id: Int, i: Int, n: io.gatling.core.session.Session => io.gatling.commons.validation.Validation[String]): HttpCheck =
    ...
    object relation {
      ...
      object member {
        def t(id: Int, i: Int, t: io.gatling.core.session.Session => io.gatling.commons.validation.Validation[String]): HttpCheck =
          xpath("""/osm/relation[@id="""" + id + """"]/member[""" + i + """]/@type""").is(t)
        def ref(id: Int, i: Int, n: io.gatling.core.session.Session => io.gatling.commons.validation.Validation[String]): HttpCheck =
          xpath("""/osm/relation[@id="""" + id + """"]/member[""" + i + """]/@ref""").is(n)
        def role(id: Int, i: Int, r: io.gatling.core.session.Session => io.gatling.commons.validation.Validation[String]): HttpCheck =
