        ...
        exec(
          http("attributes")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="1001"]/@lat""").transform(s => stripZero(Option(s))).is("1.001"),
              xpath("""/osm/node[@id="1001"]/@lon""").transform(s => stripZero(Option(s))).is("1.001"),
        ...
        .exec(
          http("different attributes")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="1002"]/@lat""").transform(s => stripZero(Option(s))).is("1.002"),
              xpath("""/osm/node[@id="1002"]/@lon""").transform(s => stripZero(Option(s))).is("1.001"),
        ...
        .exec(
          http("multiple tags")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="1005"]/@lat""").transform(s => stripZero(Option(s))).is("1.005"),
              xpath("""/osm/node[@id="1005"]/@lon""").transform(s => stripZero(Option(s))).is("1.001"),
        ...
        .exec(
          http("anonymous user")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="1003"]/@lat""").transform(s => stripZero(Option(s))).is("1.003"),
              xpath("""/osm/node[@id="1003"]/@lon""").transform(s => stripZero(Option(s))).is("1.001"),
        ...
        .exec(
          http("multiple tags")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="1006"]/@lat""").transform(s => stripZero(Option(s))).is("1.006"),
              xpath("""/osm/node[@id="1006"]/@lon""").transform(s => stripZero(Option(s))).is("1.001"),
        ...
        exec(
          http("recreated")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="2002"]/@lat""").transform(s => stripZero(Option(s))).is("1.001"),
              xpath("""/osm/node[@id="2002"]/@lon""").transform(s => stripZero(Option(s))).is("1.102"),
        ...
        .exec(
          http("recreated as untagged")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="2004"]/@lat""").transform(s => stripZero(Option(s))).is("1.001"),
              xpath("""/osm/node[@id="2004"]/@lon""").transform(s => stripZero(Option(s))).is("1.104"),
        ...
        .exec(
          http("diff created")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="2005"]/@lat""").transform(s => stripZero(Option(s))).is("1.001"),
              xpath("""/osm/node[@id="2005"]/@lon""").transform(s => stripZero(Option(s))).is("1.105"),
        ...
        .exec(
          http("diff created tagged")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="2006"]/@lat""").transform(s => stripZero(Option(s))).is("1.001"),
              xpath("""/osm/node[@id="2006"]/@lon""").transform(s => stripZero(Option(s))).is("1.106"),
        ...
        .exec(
          http("moved")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="2007"]/@lat""").transform(s => stripZero(Option(s))).is("1.001"),
              xpath("""/osm/node[@id="2007"]/@lon""").transform(s => stripZero(Option(s))).is("1.1071"),
        ...
        .exec(
          http("moved tagged")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="2008"]/@lat""").transform(s => stripZero(Option(s))).is("1.001"),
              xpath("""/osm/node[@id="2008"]/@lon""").transform(s => stripZero(Option(s))).is("1.1081"),
