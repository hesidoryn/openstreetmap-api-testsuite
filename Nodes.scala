        ...
        exec(
          http("recreated")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="2002"]/@lat""").is("1.001"),
              xpath("""/osm/node[@id="2002"]/@lon""").is("1.102"),
        ...
        .exec(
          http("recreated as untagged")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="2004"]/@lat""").is("1.001"),
              xpath("""/osm/node[@id="2004"]/@lon""").is("1.104"),
        ...
        .exec(
          http("diff created")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="2005"]/@lat""").is("1.001"),
              xpath("""/osm/node[@id="2005"]/@lon""").is("1.105"),
        ...
        .exec(
          http("diff created tagged")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="2006"]/@lat""").is("1.001"),
              xpath("""/osm/node[@id="2006"]/@lon""").is("1.106"),
        ...
        .exec(
          http("moved")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="2007"]/@lat""").is("1.001"),
              xpath("""/osm/node[@id="2007"]/@lon""").is("1.1071"),
        ...
        .exec(
          http("moved tagged")
            ...
            .check(
              ...
              xpath("""/osm/node[@id="2008"]/@lat""").is("1.001"),
              xpath("""/osm/node[@id="2008"]/@lon""").is("1.1081"),
